...
function CreateStudent(props) {
  const [student, setStudent] = useState({ _id: '', firstName: '', lastName: '', address:'', city:'', phoneNumber:'', program:'',
  ...
  const saveStudent = (e) => {
    ...
    e.preventDefault();
  //  alert(apiUrl);      
    const data = { firstName: student.firstName, lastName: student.lastName, address:student.address, city:student.city, phoneNumber:student.phoneNumber,
      program:student.program, email: student.email,studentnumber: student.studentnumber, password: student.password };
     
    axios.post(apiUrl, data)
      .then((result) => {
        alert('Your Account is saved');
