...
function EditCourse(props) {
  ...
  const [course, setCourse] = useState({ _id: '', courseCode: '', 
      ...
      <Jumbotron>
        <Form onSubmit={updateCourse}>
          ...
          <Form.Group>
            ...
            <Form.Control type="text" name="semester" id="semester" placeholder="Enter semester" value={course.semesterS} onChange={onChange} />
          </Form.Group>
